...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-actions.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-actions)
...
```bash
php artisan vendor:publish --tag="laravel-actions-migrations"
php artisan migrate
```
...
```php
$laravelActions = new DiegoVasconcelos\Actions();
echo $laravelActions->echoPhrase('Hello, Dvws!');
```
